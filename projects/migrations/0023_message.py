...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('projects', '0022_project_category'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('comment', 'Comment'), ('alert', 'Alert'), ('forum', 'Forum Post'), ('love', 'Love'), ('favorite', 'Favorite'), ('remix', 'Remix')], max_length=20)),
