"""
Django settings for scratch_clone project.
...
ROOT_URLCONF = 'scratch_clone.urls'
...
WSGI_APPLICATION = 'scratch_clone.wsgi.application'
...
LANGUAGE_ROOT = BASE_DIR / STATIC_URL / "languages"
...
LOGGING = {
    ...
    'root': {  # catches any logger with no specific config
        'handlers': ['console'],
        'level': 'INFO',
    },
    'loggers': {
        ...
        # optional: match the module where you’re calling logger.info
        'projects': {
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': False,
